    ...
    <div class="panel panel-flat">
        ...
        <div class="panel-body">
            <p class="content-group-lg">Validate.js makes simple clientside form validation easy, whilst still offering
                plenty of customization options. The plugin comes bundled with a useful set of validation methods, including
                URL and email validation, while providing an API to write your own methods. All bundled methods come with
            ...
            <form id="" class="form-horizontal form-validate-jquery"
                action="{{ route('student.update', [$students->id]) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <fieldset class="content-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-9">
                            <input type="text" name="roll" value="{{ $students->roll }}" class="form-control"
                                required="required" placeholder="Enter Your Varsity ID">
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-9">
                            <input type="email" name="email" value="{{ $students->email }}" class="form-control"
                                id="email" required="required" placeholder="Enter a valid email address">
                        </div>
                    </div>
                    <!-- /email field -->
